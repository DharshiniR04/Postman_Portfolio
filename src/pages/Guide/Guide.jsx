    ...
    return (
        <div className="guide">
            ...
            <div className="api-detail">
                ...
                <li>Enter the api url "http://api.dharshini.com/v1/" on the serach bar manually or copy it from the clipboard from the workspace on the top right corner and paste it on the serachbar </li>
